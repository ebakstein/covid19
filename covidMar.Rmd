...
```{r plot-CZ}
covidCZ %>% reshape2::melt(id=c('Date')) %>% ggplot(aes(x=Date,y=value,col=variable)) + geom_line() + ggtitle('COVID-19 Czech Republic: number of tests (UZIS data)')
...
outbreakCZ<-min(covidCZjhu$Date[covidCZ$cases>0])
